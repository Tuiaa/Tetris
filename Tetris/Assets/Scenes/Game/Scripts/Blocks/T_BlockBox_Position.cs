 ...
 */
public class T_BlockBox_Position : MonoBehaviour
{
    ...
    public void setStartPositions()
    {
        ...
        box3.GetComponent<BoxPosition>().arrayPosX = arrayPosX - 2;
        box3.GetComponent<BoxPosition>().arrayPosY = arrayPosY;

        box4.GetComponent<BoxPosition>().arrayPosX = arrayPosX - 1;
